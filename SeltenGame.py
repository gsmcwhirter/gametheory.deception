...
class SeltenGame(Immutable):
    ...
    def __init__(self, num_aspects, num_states, num_messages, sender_payoffs, receiver_payoffs):
        ...
        self.state_tuples = tuple(apply(itertools.product, self.state_lists))
        ...
        self.message_tuples = tuple(apply(itertools.product, self.message_lists))
...
def run_simulation(sg, fname, generations, default_weight=2.):
